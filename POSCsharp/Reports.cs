...
namespace POSCsharp
{
    public partial class Reports : Form
    {
        ...
        private void bunifuFlatButton1_Click(object sender, EventArgs e)
        {
            connection.Open();
            MySqlCommand com;
            com = new MySqlCommand("select count(revenue) from sales.reports", connection);
            var obj = com.ExecuteScalar();
            int rev = Convert.ToInt32(obj);
            //MessageBox.Show(rev.ToString());
            bunifuGauge1.Value = rev;
            connection.Close();
        }
        ...
        private void bunifuFlatButton3_Click(object sender, EventArgs e)
        {
            connection.Open();
            MySqlCommand com;
            com = new MySqlCommand("select sum(revenue) from sales.reports", connection);
            var obj = com.ExecuteScalar();
            int rev = Convert.ToInt32(obj);
            //MessageBox.Show(rev.ToString());
            bunifuCircleProgressbar1.MaxValue = 100000;
            bunifuCircleProgressbar1.Value = rev;
        ...
        public void table7()
        {
            ...
            MySqlCommand cmdDatabase = new MySqlCommand("select did as ' ID', dname as ' Name', dtype as 'Type',dbrand as 'Brand',dtype as 'Type', dqty as 'Stocks',dprice as 'Price',datepurchased as 'Date',datetobedelivered as 'DateDelivery' from sales.delivery ;", con);
        ...
        private void bunifuFlatButton5_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    connection.Open();
                    Chunk c7 = new Chunk("Overall Sum of Expenses in Delivery    " + this.dateTimePicker1.Text + "\n");
                    Paragraph para3 = new Paragraph();
                    com = new MySqlCommand("select sum(dprice) from sales.delivery", connection);
                    var obj3 = com.ExecuteScalar();
                    int reva = Convert.ToInt32(obj3);
                    //MessageBox.Show(rev.ToString());
                    string rev4 = reva.ToString();
                    Chunk ca = new Chunk(rev4);
                    para3.Add(c7);
                    para3.Add(ca);
                    doc.Add(para3);
                    connection.Close();
